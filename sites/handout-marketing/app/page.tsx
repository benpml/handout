const appOrigin = "https://app.handout.link";
...
const faqs = [
  ...
  [
    ...
    "Handout helps you understand meaningful buyer activity, including visits, return visits, content engagement, and sharing signals.",
  ],
  [
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="audience" aria-label="Teams that use Handout">
        ...
        <section className="section" id="how-it-works">
          <div className="container">
            <SectionHeading eyebrow="How it works" title="From scattered follow-up to one clear next step." description="Handout gives every deal a polished destination—and gives you the context to follow up at the right moment." />
            <div className="steps">
        ...
        <section className="section pricing" id="pricing">
          <div className="container pricing-grid">
            <SectionHeading eyebrow="Pricing" title="Start with the deal in front of you." description="Create your first Handout for free. No card, no setup call, and no reason to keep sending attachment-heavy follow-ups." />
        ...
        <section className="final-cta section">
          <div className="container cta-panel">
            ...
            <p>Build a Handout in minutes and give your prospect a better way to say yes.</p>
  ...
  return (
    <header className="site-header">
      <div className="container header-inner">
        <a className="logo-link" href="#top" aria-label="Handout home"><img src="/handout-logo.svg" alt="Handout" width="90" height="18" /></a>
...
function ProductPreview() {
  return (
    <div className="preview-stage">
      <div className="live-toast"><i /><div><strong>Maya is viewing your Handout</strong><span>Business case · just now</span></div></div>
      <div className="browser-frame">
        <div className="browser-bar"><span className="dots"><i /><i /><i /></span><span className="address">↗ handout.link/acme/launch-plan</span><span className="live"><i /> Live</span></div>
...
function Footer() {
  return <footer><div className="container footer-inner"><a className="logo-link" href="#top" aria-label="Back to top"><img src="/handout-logo.svg" alt="Handout" width="90" height="18" /></a><nav aria-label="Footer navigation">{nav.map(([label,href])=><a key={href} href={href}>{label}</a>)}<a href="#faq">FAQ</a><a href={`${appOrigin}/auth`}>Log in</a></nav><small>© {new Date().getFullYear()} Handout</small></div></footer>;
}
