...
function createEmptyImageNodeView({
  ...
  dom.dataset.handoutImageEmpty = ""
  dom.dataset.node = "image"
  dom.className = "handout-editor-image-empty"
  input.accept = "image/*"
  input.ariaHidden = "true"
  input.className = "handout-editor-image-empty-input"
  input.hidden = true
  input.tabIndex = -1
  input.type = "file"
  button.className = "handout-editor-image-empty-button"
  button.type = "button"
  title.className = "handout-editor-image-empty-title"
  title.textContent = "Upload image"
  description.className = "handout-editor-image-empty-description"
