...
import { SiteGifBlock } from "@handout/site-document"
import type { Node as ProseMirrorNode } from "@tiptap/pm/model"

export const HandoutGif = SiteGifBlock.extend({
  addNodeView() {
...
function createEmptyGifNodeView({
  ...
  dom.dataset.handoutGifEmpty = ""
  dom.dataset.node = "gifBlock"
  dom.className = "handout-editor-gif-empty"
  button.className = "handout-editor-gif-empty-button"
  button.type = "button"
  title.className = "handout-editor-gif-empty-title"
  title.textContent = "Select GIF"
  description.className = "handout-editor-gif-empty-description"
