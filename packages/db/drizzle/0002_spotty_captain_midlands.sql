...
ALTER TABLE "sites" ALTER COLUMN "draft_content" SET DEFAULT '{"schemaVersion":2,"chrome":{"siteHeader":{"brandName":"Handout","logoUrl":"","primaryButtonText":"Book a call","primaryButtonHref":"","secondaryButtonText":"Learn more","secondaryButtonHref":"","showSecondaryButton":false},"hero":{"avatarMode":"single","eyebrow":"","title":"Untitled Handout","subtitle":"","avatarImageUrl":"","avatarImageVariableKey":"","avatarImageAlt":"","avatarImageSecondaryUrl":"","avatarImageSecondaryVariableKey":"","avatarImageSecondaryAlt":""}},"settings":{"showTableOfContents":true,"allowSearchIndexing":false},"variables":[{"id":"recipient_website","key":"recipient_website","label":"Recipient website","type":"url","defaultValue":""}],"blocks":[]}'::jsonb;--> statement-breakpoint
